using Dapper;
using GraphQL.Language.AST.Extensions.Extensions;
...
namespace GraphQL.Language.AST.Extensions.Context
{
    public class SqlDeleteContext
    {
        ...
        public int Execute(IDbConnection connection, IDbTransaction transaction = null, SqlServerMapperOptions options = null)
        {
            if (options == null)
            {
                options = SqlServerMapperOptions.DefaultOptions;
            }
        ...
        /// <param name="transaction">The transaction to execute under (optional).</param>
        /// <param name="options">The options for the command (optional).</param>
        public async Task<int> ExecuteAsync(IDbConnection connection, IDbTransaction transaction = null, SqlServerMapperOptions options = null)
        {
            if (options == null)
            {
                options = SqlServerMapperOptions.DefaultOptions;
