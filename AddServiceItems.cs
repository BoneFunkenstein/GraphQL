...
namespace GraphQL.Language.AST.Extensions
{
    ...
    /// </summary>
    public class AddRocketFuel
    {
        private readonly IServiceCollection serviceCollection;

        public AddRocketFuel(IServiceCollection serviceCollection)
        {
        ...
        public AddRocketFuel AddQueryBuilder<TModelType, TQueryBuilder>()
        ...
        /// <returns>The GraphQLOptions object.</returns>
        public AddRocketFuel AddQueryBuilder(Type modelType, Type queryBuilderType)
        {
        ...
        /// <returns>The GraphQLOptions object.</returns>
        public AddRocketFuel AddSchema<TGraphSchema>() where TGraphSchema : class, ISchema
        {
        ...
        /// <returns>The GraphQLOptions object.</returns>
        public AddRocketFuel AddSchema(Type graphSchemaType)
        {
        ...
        /// <returns>The GraphQLOptions object.</returns>
        public AddRocketFuel AddType<TGraphType>() where TGraphType : class, IGraphType
        {
        ...
        /// <returns>The GraphQLOptions object.</returns>
        public AddRocketFuel AddType(Type type)
        {
